...
export const en = {
    ...
    'invoice.upload.photo': 'Invoice photo',
    'invoice.upload.uploading': 'Uploading…',
    'invoice.upload.submit': 'Upload invoice',
    'invoice.upload.needBoth':
        'Choose a supplier and an invoice photo to continue.',
    ...
    'invoice.review.rereadConfirm':
        'Read this invoice again? Your changes on this screen will be replaced by a fresh reading.',
    ...
    'invoice.review.backToUpload': 'Back to upload',
    ...
    'invoice.review.lineItems': 'Line items ({count})',
    'invoice.review.addLine': 'Add line',
    'invoice.review.removeConfirm': 'Remove this line?',
    'invoice.review.selected_one': '{count} line selected',
    'invoice.review.selected_other': '{count} lines selected',
    ...
    'invoice.review.needProduct_one': 'Choose a product for {count} selected line.',
    'invoice.review.needProduct_other': 'Choose a product for {count} selected lines.',
    ...
    'invoice.line.itemName': 'Item name',
    'invoice.line.itemNamePlaceholder': 'Product name',
    'invoice.line.brand': 'Brand (optional)',
    'invoice.line.brandPlaceholder': 'Brand',
    'invoice.line.barcode': 'Barcode',
    'invoice.line.scan': 'Scan',
    'invoice.line.scanTitle': 'Scan to match a product',
    'invoice.line.barcodePlaceholder': 'Scan or type barcode',
    'invoice.line.matchedProduct': 'Matched product',
    'invoice.line.creating': 'Creating…',
    'invoice.line.createNew': 'Create new',
    'invoice.line.noMatch': 'No product matched',
    'invoice.line.change': 'Change',
    'invoice.line.select': 'Select',
    'invoice.line.searchPlaceholder': 'Search products…',
    'invoice.line.searching': 'Searching…',
    'invoice.line.noResults': 'No products found',
    ...
    'invoice.line.unitPrice': 'Unit price (excl. VAT)',
    'invoice.line.updateStock': 'Update stock level',
    'invoice.line.updatePrice': 'Update what it costs you',
    'invoice.line.badgeNone': 'No product',
    'invoice.line.badgeHigh': 'High match',
    'invoice.line.badgeMedium': 'Medium match',
    'invoice.line.badgeLow': 'Low match',
    'invoice.line.matched': 'Matched to {name}',
    'invoice.line.noBarcodeMatch': 'No product has the barcode {barcode}',
    'invoice.line.nameRequired': 'A name is needed to create a product.',
    'invoice.line.created': 'Product created',

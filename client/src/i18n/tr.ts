...
export const tr: Dictionary = {
    ...
    'invoice.list.continue': 'Devam et',
    'invoice.list.startedAt': '{when} başlandı',
    ...
    'invoice.upload.step1': 'Kimden geldi?',
    'invoice.upload.step1Hint': 'Bu faturayı gönderen tedarikçi.',
    ...
    'invoice.upload.step2': 'Faturanın fotoğrafı',
    'invoice.upload.step2Hint': 'Satırları bu fotoğraftan okuyoruz, bu yüzden iyi çekmeye değer.',
    'invoice.upload.choosePhoto': 'Fotoğraf çekin ya da seçin',
    'invoice.upload.changePhoto': 'Başka bir fotoğraf kullan',
    'invoice.upload.choosePhotoHint': 'Kameranız ya da galeriniz',
    'invoice.upload.previewAlt': 'Seçtiğiniz fatura fotoğrafı',
    'invoice.upload.tipsTitle': 'En iyi okuma için',
    'invoice.upload.tipFlat': 'Faturayı düz bir zemine koyup kamerayı tam üstünde tutun.',
    'invoice.upload.tipWhole': 'Sayfanın tamamı, kenarlarıyla birlikte kadraja girsin.',
    'invoice.upload.tipLight': 'Işık iyi olsun ve kendi gölgeniz sayfaya düşmesin.',
    'invoice.upload.uploading': 'Yükleniyor…',
    'invoice.upload.submit': 'Yükle ve okut',
    'invoice.upload.whatNext': 'Faturayı okuyacağız — yaklaşık bir dakika — sonra satırları siz kontrol edeceksiniz.',
    'invoice.upload.needBoth': 'Devam etmek için bir tedarikçi ve bir fotoğraf seçin.',
    'invoice.upload.notAnImage': 'Lütfen bir resim dosyası seçin.',
    'invoice.upload.done': 'Fatura yüklendi',
    'invoice.upload.noSuppliers': 'Önce bir tedarikçi ekleyin',
    'invoice.upload.noSuppliersHint':
        'Her fatura onu gönderene aittir; yüklemeden önce o tedarikçiyi ekleyin.',
    'invoice.upload.addSupplier': 'Tedarikçi ekle',
    ...
    'invoice.review.rereadTitle': 'Fatura yeniden okunsun mu?',
    'invoice.review.rereadBody':
        'Fotoğraf baştan okunacak. Aşağıdaki rakamlar kâğıtla uyuşmuyorsa bunu kullanın.',
    'invoice.review.rereadConfirm':
        'Fotoğraf baştan okunacak ve bu ekranda yaptığınız değişikliklerin yerini yeni okuma alacak.',
    ...
    'invoice.review.backToInvoices': 'Faturalara dön',
    ...
    'invoice.review.documentLabel': 'Fatura bilgileri',
    'invoice.review.linesLabel': 'Fatura satırları',
    'invoice.review.noLines': 'Bu faturadan hiçbir satır okunamadı. Satırları elle ekleyin ya da yeniden okutun.',
    'invoice.review.noneInFilter': 'Burada satır yok.',
    'invoice.review.addLine': 'Elle satır ekle',
    'invoice.review.addLineHint': 'Kâğıtta olup gözden kaçan her şey için.',
    ...
    'invoice.review.willApply_one': '{count} satır uygulanacak',
    ...
    'invoice.review.tipProduct':
        'Neyin güncelleneceğini bilmemiz için her satıra dükkânınızdan bir ürün seçin.',
    'invoice.review.tipApply':
        'Uygula\'ya basana kadar hiçbir şey değişmez. Sonrasında stok artar ve alış fiyatı kaydedilir.',

    // Invoice review, one line -------------------------------------------------
    'invoice.line.newItem': 'Yeni satır',
    'invoice.line.includeLabel': '{name} bu faturaya dahil edilsin',
    'invoice.line.excludedNote': 'Dışarıda - hiçbir şey değişmeyecek',
    'invoice.line.noProductYet': 'Henüz ürün seçilmedi',
    'invoice.line.summaryNumbers': '{quantity} × {price}',
    'invoice.line.effectStockShort': 'stok',
    'invoice.line.effectPriceShort': 'alış',
    'invoice.line.stateReady': 'Hazır',
    'invoice.line.stateAttention': 'Sizi bekliyor',
    'invoice.line.stateExcluded': 'Dışarıda',
    'invoice.line.asPrinted': 'Kâğıtta:',
    'invoice.line.asPrintedNumbers': '{quantity} {unit} · toplam {total}',
    'invoice.line.code': 'Kod: {code}',
    'invoice.line.barcodeTag': 'Barkod: {barcode}',
    'invoice.line.product': 'Bu hangi ürün?',
    'invoice.line.productHint': 'Bu satırın stok ve alış fiyatını güncelleyeceği ürün.',
    'invoice.line.choose': 'Ürün seç',
    'invoice.line.change': 'Değiştir',
    'invoice.line.quantity': 'Kaç adet geldi?',
    'invoice.line.quantityHint': 'Tedarikçi nasıl faturalamış olursa olsun, tam sayı olarak.',
    'invoice.line.unitPrice': 'Bir tanesi size kaça geldi? (KDV hariç)',
    'invoice.line.unitPriceHint': 'Tedarikçiye ödediğiniz tutar; sattığınız fiyat değil.',
    'invoice.line.willDo': 'Bu satır uygulanınca:',
    'invoice.line.updateStock': 'Stok miktarını güncelle',
    'invoice.line.updatePrice': 'Alış fiyatını güncelle',
    'invoice.line.effectStockAdd': 'Raftakine {quantity} eklenecek.',
    'invoice.line.effectStockRemove': 'Raftakinden {quantity} düşülecek.',
    'invoice.line.effectStockUnknown': 'Yukarıya tam sayı girin, burada ne değişeceği yazacak.',
    'invoice.line.effectPriceSet': 'Bir tanesinin yeni alış fiyatı {price} olarak kaydedilecek.',
    'invoice.line.effectPriceUnknown': 'Yukarıya bir tutar girin, burada ne değişeceği yazacak.',
    'invoice.line.remove': 'Bu satırı kaldır',
    'invoice.line.removeConfirmTitle': 'Bu satır kaldırılsın mı?',
    'invoice.line.removeConfirmBody': 'Bu satırı elle eklemiştiniz, doğrudan kaldırılacak.',
    ...
    'invoice.problem.quantity': 'Sıfırdan farklı bir tam sayı girin.',
    'invoice.problem.price': 'Bir tanesinin size kaça geldiğini girin.',
    'invoice.problem.nothingToUpdate':
        'Bu satır dahil ama hiçbir şeyi değiştirmeyecek. Yukarıdakilerden birini işaretleyin ya da satırı dışarıda bırakın.',

    // Choosing a product ------------------------------------------------------
    'picker.title': 'Ürün seç',
    'picker.createTitle': 'Yeni ürün',
    'picker.searchLabel': 'Ürünlerinizde arayın',
    'picker.searchHint': 'Faturadaki adı yazdık; sonuç çıkmazsa değiştirin.',
    'picker.searchPlaceholder': 'Ürün adı',
    'picker.searching': 'Aranıyor…',
    'picker.resultsLabel': 'Eşleşen ürünler',
    'picker.resultCount': '{count} ürün bulundu',
    'picker.noDetails': 'Marka ya da barkod yok',
    'picker.noResults': '“{query}” ile eşleşen bir ürününüz yok.',
    'picker.typeToSearch': 'Bir ad yazın ya da kutudaki barkodu okutun.',
    'picker.scan': 'Barkod okut',
    'picker.scanTitle': 'Ürün bulmak için okutun',
    'picker.barcodeUnknown': 'Henüz {barcode} barkodlu bir ürün yok.',
    'picker.createNew': 'Yeni ürün oluştur',
    'picker.createHint':
        'Bu, dükkânınıza yeni bir ürün ekler. Bilgiler fotoğraftan geldi, kontrol edin.',
    'picker.name': 'Ürün adı',
    'picker.namePlaceholder': 'Dükkânda ne diyorsanız',
    'picker.nameRequired': 'Ürün oluşturmak için bir ad gerekli.',
    'picker.brand': 'Marka',
    'picker.brandPlaceholder': 'Marka',
    'picker.barcode': 'Barkod',
    'picker.barcodeHint': 'Sonradan okutarak bu ürünü bulmanızı sağlar.',
    'picker.barcodePlaceholder': 'Barkodu okutun ya da yazın',
    'picker.createConfirm': 'Bu ürünü oluştur',
    'picker.backToSearch': 'Aramaya dön',
    'picker.created': '{name} dükkânınıza eklendi',
